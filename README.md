...
specifically for the Master's and Doctoral programmes of the **NOVA
Information Management School (NOVA IMS)**.

It is intended primarily for NOVA IMS students, supervisors, and
academic services requiring a consistent and institution-approved LaTeX
template for dissertations and theses.
...
-   NOVA IMS--specific **front and back covers** for all programmes and
    specializations\
...
This template mirrors the NOVAthesis structure to ensure future
compatibility.
...
-   `nova/ims/nova-ims-defaults.ldf` --- All programme/specialization
    options\
...
## 6.1 Master's in Information Management --- **MGI**
  ...
  Programme   Specialization   English Name
  ----------- ---------------- -------------------------------------------------------
...
## 6.6 Doctoral Programme in Information Management --- **DGI**
  ...
  Programme   Specialization   Notes
  ----------- ---------------- ---------------------------------
